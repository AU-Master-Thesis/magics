//! Identifiers for factorgraph components
//!
//! This module provides unique identifiers for factors and variables in the factorgraph.

use super::factorgraph::{FactorGraphId, FactorIndex, VariableIndex};

/// Unique identifier of a factor in the world.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, derive_more::Display)]
#[display(fmt = "{:?}-{}", factorgraph_id, "factor_index.0.get()")]
pub struct FactorId {
...
impl std::cmp::PartialOrd for FactorId {
    ...
    /// # NOTE
    ///
    /// This ordering is really important for the GBP planner algorithm to
    /// work correctly.
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, derive_more::Display)]
#[display(fmt = "{:?}-{}", factorgraph_id, "variable_index.0.get()")]
