//! Pose factor for directly controlling robot positions
//!
//! This module implements the pose factor which provides direct control
//! over robot positions in the planning algorithm.
...
/// Pose factor for direct control of robot positions
#[derive(Debug)]
