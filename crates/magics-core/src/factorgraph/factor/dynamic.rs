...
//!
//! This module implements the dynamic factor for the Gaussian Belief Propagation
//! algorithm, which models the constant velocity of an agent.
...
impl DynamicFactor {
    ...
    /// # Arguments
    /// 
    /// * `state` - The factor state to initialize
    /// * `delta_t` - The time step for the dynamic model
    #[must_use]
