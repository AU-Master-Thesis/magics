...
use crate::{
    ...
    ui::{UiScaleType, UiState},
};

/// Plugin for UI input handling
...
pub enum UiAction {
    ...
    /// Toggle visibility of the bottom panel
    ToggleBottomPanel,
    #[display(fmt = "Toggle Metrics Window")]
    /// Toggle visibility of the metrics window
    ToggleMetricsWindow,
...
impl UiAction {
    /// Get the default keyboard input for a UI action
